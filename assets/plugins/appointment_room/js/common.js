...
var tokbox_session_id = localStorage.getItem('tokbox_session_id');
...
//Doctor Detail
var doctor_info = JSON.parse(localStorage.getItem('doctor_info'));
...
$(window).load(function () {
    ...
    $(".patient_name").html(patient_info.Name);
    $(".doctor_short_detail").html(doctor_info.Info);
    $(".patient_short_detail").html("Location: " + patient_info.Location);
